...
<?php if ( $notes = $subscription->get_customer_order_notes() ) :
	?>
	<h2 class="h4"><?php esc_html_e( 'Subscription Updates', 'woocommerce-subscriptions' ); ?></h2>
...
<h2 class="h4"><?php esc_html_e( 'Subscription Totals', 'woocommerce-subscriptions' ); ?></h2>
